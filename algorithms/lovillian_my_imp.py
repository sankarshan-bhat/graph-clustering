...
community_df.to_csv('Community_List_louvain_inweb.csv')
...
nx.draw_networkx(G, pos_louvain, cmap=plt.get_cmap('magma'), node_color=values,node_size=30, with_labels=False)
plt.suptitle('Louvain Clustering for bio-CE-LC data',fontsize=22)
plt.box(on=None)
plt.axis('off')
plt.savefig('louvain_PPI_Inweb.png',dpi=400, bbox_inches='tight')
plt.show()
